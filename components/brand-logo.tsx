...
encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' width='120' height='24' viewBox='0 0 120 24'><rect width='120' height='24' rx='6' fill='%231e40af'/><text x='12' y='16' font-size='12' font-family='Arial, Helvetica, sans-serif' fill='white'>KlinikIA</text></svg>`)


const candidates = React.useMemo(
() => (srcs?.length ? srcs : [
"/logo_oficial.png", // produção (public)
DATA_URI, // fallback
]),
[srcs]
)
