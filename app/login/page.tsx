...
<Card>
<CardHeader><CardTitle>Entrar no painel</CardTitle></CardHeader>
...
<div className="text-sm text-muted-foreground">ou <a className="underline" href="/autocadastro">autocadastrar paciente</a></div>
</CardContent>
</Card>
</div>
)
